...
When the customer enters the event details such as Date "2024-12-27", time "5:00 pm", description "A celebration", attendeeCount "300", name "omar party",category "Birthday" ,theme "Decades Theme",Venue "V1",eventid "2000"
