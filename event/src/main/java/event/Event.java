...
public class Event {
    ...
    public Event(String name, Date date, String time,  String description, int attendeeCount, String UserID, String theme ,String category,int Eid) {
        this .UserID=UserID; 
        this.name = name;
        this.date = date;
        this.time = time;
    ...
    public  void addEventToFile(Event event,String filename)
    {
        try {
            ...
            eventsFile.append(event.getName()).append(" , ")
                    ...
                    .append(Integer.toString(event.getEID()));
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (items.length >= 9) {
                    ...
                    int eventID = Integer.parseInt(items[8]);
           ...
           toupdatedEvent.printing.printSomething('\n'+
            ...
            switch (choice) {
                ...
                case "2":
  	               ...
  	               toupdatedEvent.setDate(java.sql.Date.valueOf(dateInput));
