...
//    public void theAdministratorProvidesTheDiscountDetailsSuchAs(String string, String string2, String string3, String string4){
//        discount.setdiscountcode(string);
//        discount.setsiscountid(Integer.parseInt(string2));
//        discount.setdiscountpercentage(Double.parseDouble(string3));
//        discount.setvalidity(string4);
//        // You can set the applicable products/services here as well
//        // discount.setApplicableProductsServices(productservices);
//        adding = true;
//        throw new io.cucumber.java.PendingException();
//    }
    @When("the administrator provides the discount details such as {string}, {string}, {string}, and {string}")
