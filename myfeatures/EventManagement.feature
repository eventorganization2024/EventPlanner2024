...
When the customer enters the event details such as Date "2024-12-27", time "5:00 pm", description "A celebration", attendeeCount 300, name "omar party",category "Birthday" ,theme "Decades Theme",eventid 2000
...
When the administrator enters the event details such as Date "2024-3-24", time "5:00 pm", description "A celebration", attendeeCount 200, name "reem party",category "Birthday" ,theme "Decades Theme",eventid 1000
