...
Given the Administrator has selected show users
...
Scenario: User views list of venues
Given the USer has selected show venues
Then the list of venues  displayed

Scenario: User views list of  providers
Given the User has selected show providers
Then the list of  providers  displayed
